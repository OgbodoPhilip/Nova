...
const TitanHero = () => {
  return (
    <div className="min-h-screen bg-red p-2 md:p-1 font-sans antialiased selection:bg-[#CCFF00] selection:text-black">
      ...
      <div className="relative min-h-[calc(100vh-3rem)] w-full overflow-hidden rounded-[3rem] border-[12px] border-[#1A1A1A] bg-[#0A0A0A]">
            ...
            >
              {["Be healthier.", "Be stronger.", "Be confident."].map((text, i) => (
                <motion.h1 
                  ...
                  className="text-6xl md:text-7xl  xl:text-7xl font-bold tracking-tight text-white leading-[0.95]"
                >
                  {text}
                </motion.h1>
              ))}
        ...
        <div className="relative z-20 px-5 md:px-12 pb-12 mt-1 grid grid-cols-1 md:grid-cols-12 gap-5 mt-[-70] md:mt-0">
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-white uppercase tracking-wider">Satisfied clients</p>
              </div>
            </div>
          ...
          >
            <div className="rounded-[0.9rem] bg-white/5 border border-white/5 p-4 backdrop-blur-sm">
              <div className="flex justify-between items-center mb-4">
                <motion.button whileTap={{scale:0.9}} className="p-2 rounded-full bg-white/10 text-white"><ChevronLeft size={16}/></motion.button>
                ...
                <motion.button whileTap={{scale:0.9}} className="p-2 rounded-full bg-white/10 text-white"><ChevronRight size={16}/></motion.button>
              </div>
          ...
          >
            <motion.div whileTap={{scale:0.9}} className="absolute top-6 right-6 h-10 w-20 rounded-full bg-black flex items-center justify-center text-[#CCFF00]">
            ...
            <div className="mt-2">
              ...
              <p className="mt-2 text-sm font-semibold opacity-70">
                Just give us a call or message us in the chat. Just give us a call or message us in the chatJust give us a call or message us in the chatJust give us a call or message us in the chat
              </p>
            </div>
          </motion.div>
        </div>
